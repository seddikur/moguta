                    ...
                    if (response.data) {
                        for (i = 0; i < response.data.length; i++) {
                          ...
                          <li style="list-style-type: none;" class="delete-order" id="">\
                                            <a class="tool-tip-bottom delete-gallery fa fa-trash" data-id="' + response.data[i].id + '" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>\
                                        </li></td>';
                            table += '</tr>';
                        }
                    }
            ...
            admin.ajaxRequest({
                ...
                function (response) {
                    if (response.msg == 'Succes') {
                        admin.indication(response.status, 'Галерея сохранена');
                    } else {
            ...
            admin.ajaxRequest({
                ...
                function (response) {
                    if (response.data != null) {
                        ...
                        $('#add-plug-modal #mg-gallery').html(imgList);
                    }
                }
            );
        },
