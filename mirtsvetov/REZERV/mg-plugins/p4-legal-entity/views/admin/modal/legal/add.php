                        ...
                        <div class="p-modal__item">
                            ...
                            <div class="p-modal__content">
                                <div class="p-modal-form__field">
                                    ...
                                    <input type="text" class="p-modal-form__input" name="legal_name" autocomplete="off">
                                </div>
                                <div class="p-modal-form__field">
                        ...
                        <div class="p-modal__item">
                            ...
                            <div class="p-modal__content">
                                <div class="p-modal-form__field">
                                    ...
                                    <input type="text" class="p-modal-form__input" name="legal_mir" autocomplete="off">
                                </div>
                                <div class="p-modal-form__field">
                                    <div class="p-modal-form__lable"><?php echo $this->lang['MODAL_LEGAL_ENTITY_DEBT_RM']; ?></div>
                                    <input type="text" class="p-modal-form__input" name="legal_rm" autocomplete="off">
                                </div>
                                <div class="p-modal-form__field">
                                    <div class="p-modal-form__lable"><?php echo $this->lang['MODAL_LEGAL_ENTITY_DEBT_TK']; ?></div>
                                    <input type="text" class="p-modal-form__input" name="legal_tk" autocomplete="off">
                                </div>
                                <div class="p-modal-form__field">
                                    <div class="p-modal-form__lable"><?php echo $this->lang['MODAL_LEGAL_ENTITY_DEBT_TARE_TANK']; ?></div>
                                    <input type="text" class="p-modal-form__input" name="legal_tare_tank" autocomplete="off">
                                </div>
                                <div class="p-modal-form__field">
                                    <div class="p-modal-form__lable"><?php echo $this->lang['MODAL_LEGAL_ENTITY_DEBT_TARE_COVER']; ?></div>
                                    <input type="text" class="p-modal-form__input" name="legal_tare_cover" autocomplete="off">
                                </div>
                            </div>
                        </div>
