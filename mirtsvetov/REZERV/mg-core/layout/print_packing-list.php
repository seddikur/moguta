...
?>
<table align="center" border="0" cellpadding="0" cellspacing="0" width="1260" style="margin: 0 auto 0;">
  <tr>
    <td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="1030">
              ...
              <tr>
                ...
                <td style="border-bottom: 1px solid #000000; padding: 1px 0;">
                  <span style="font-family: Arial, Verdana, sans-serif; font-size: 11px;">
                    <?php echo htmlspecialchars_decode($data['customerInfo'])?>
                  </span>
                </td>
              </tr>
              <tr>
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 0 0 5px 0;">
        ...
        foreach ($data['perOrders'] as $cell => $item):
          ...
          <tr>
            ...
            <td style="padding: 1px; border: 1px solid #000000;" align="center"><span style="font-family: Arial, Verdana, sans-serif; font-size: 11px;"><?php echo (empty($item['unit']) ? 'шт.' : $item['unit'])?></span></td>
