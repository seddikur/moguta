...
<div class="l-col min-0--12">
    <div class="c-apply apply-filter-line">
        ...
        <form action="<?php echo SITE.URL::getClearUri(); ?>" class="c-apply__form apply-filter-form" data-print-res="<?php echo MG::getSetting('printFilterResult') ?>" <?php echo $style ?>>
