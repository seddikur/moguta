    ...
    return {
        ...
        initEvents: function() {
                    ...
                    function(response) {
                        ...
                        if (response.status != 'error') {
                            ...
                            if (type == '#ttab2' && response.data.description) {
                                ...
                                path === '/layout/layout_agreement.php' ? $('.change-letter-template').hide() : $('.change-letter-template').show();
            ...
            $('#tab-template-settings').on('click', '#newLetterFile', function() {
                ...
                var type = 'layout';
                var fileNameIndex = path === '/layout/layout_agreement.php' ? path.lastIndexOf('layout') : path.indexOf('email_');
