...
var d={placeholder:"Выбрать",// Dont change it here.
csvDispCount:3,// display no. of items in multiselect. 0 to display all.
captionFormat:"{0} Выбрано",// format of caption text. you can set your locale.
captionFormatAllSelected:"{0} Выбраны все",// format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
...
locale:["Ок","Отмена","Выбрать все","Снять все"],// all text that is used. don't change the index.
