        ...
        <span class="section__desc" style="background:#f7f7f7;">
            ...
            <div class="widget-table-action base-settings">
                <ul class="list-option" style="padding:0px;"><!-- список опций из таблицы setting-->
                    ...
                    <li>
                        <label>
                            <span class="custom-text fl-left" style="width: 310px;">
                                <?php echo $lang['IMPORT_CATEGORY'] ?>:
                                <span tooltip="<?php echo $lang['T_TIP_IMPORT_CATEGORY'] ?>"
                    ...
                    <li>
                        <label>
                            <span class="custom-text fl-left">
                                <?php echo $lang['DO_NOT_UPDATE_EXISTING_PRODUCTS_CATS']; ?>:
                                <span tooltip="<?php echo $lang['T_TIP_DO_NOT_UPDATE_EXISTING_PRODUCTS_CATS']; ?>"
                                      class="mg-yml-tooltip"
                                      flow="rightUp">
                                    <i class="fa fa-question-circle tip"
                                       aria-hidden="true"></i>
                            ...
                            <input type="checkbox"
                                   name="doNotUpdateExistingProductsCats"
                                   value=""/>
                        </label>
                    </li>
                    <?php if (MG::enabledStorage()) : ?>
                    <br />
                    <li>
                        <label>
                            <span class="custom-text fl-left"><?php echo $lang['IMPORT_IN_WAREHOUSE'] ?>:</span>
                            <?php
                                $storagesOptions = [
                                    '-1' => 'Не импортировать',
                                ];
                                $storagesData = MG::getSetting('storages', true);
                                foreach ($storagesData as $storageData) {
                                    $storagesOptions[$storageData['id']] = $storageData['name'];
                                }
                            ?>
                            <select 
                                    id="import_in_warehouse"
                                    class="no-search js-comboBox"
                                    style="margin-top: -5px;"
                                    name="import_in_warehouse"
                                    value="<?php echo $options['import_in_warehouse']; ?>"
                                    title="<?php echo $lang['T_TIP_CAT_PROD']; ?>"
                                    tooltip="<?php echo $lang['T_TIP_IMPORT_IN_WAREHOUSE'] ?>">
                                <?php foreach ($storagesOptions as $storageId => $storageName): ?>
                    ...
                    <li>
                        <label>
                            <span class="custom-text fl-left">
                                <?php echo $lang['CHANGE_REST_PRODUCT'] ?>:
                                <span tooltip='Введите число, которое будет установлено в поле "Остаток" всех товаров из загружаемого на сайт каталога. "0" - товар отсутствует, "-1" - бесконечное количество товара или укажите свое число. Оставьте поле пустым, чтобы загрузить остатки, которые указаны в каталоге.'
                                      class="mg-yml-tooltip"
                                      flow="right">
                                    <i class="fa fa-question-circle tip"
                                       aria-hidden="true"></i>
                            ...
                            <input type="number"
                                   ...
                                   min="-1"
                                   value=""
                                   class="js-rest-product-input"
                                   placeholder="<?php echo $lang['PLACEHOLDER_REST_PRODUCT'] ?>"
                                   />
                        </label>
                    </li>
                    ...
                    <li>
                        <label>
                            <span class="custom-text fl-left">
                                <?php echo $lang['CLEAR_CATALOG_MODE'] ?>:
                                <span tooltip="<?php echo $lang['T_TIP_CLEAR_CATALOG_IMPORT'] ?>"
                                      class="mg-yml-tooltip"
                                      flow="right">
                                    <i class="fa fa-question-circle tip"
                                       aria-hidden="true"></i>
                    ...
                    <li>
                        <label>
                            <span class="custom-text fl-left">
                                <?php echo $lang['UPDATE_PRICE_MODE'] ?>:
                                <span tooltip="<?php echo $lang['T_TIP_ONLY_UPDATE_PRICE'] ?>"
                                      class="mg-yml-tooltip"
                                      flow="right">
                                    <i class="fa fa-question-circle tip"
                                       aria-hidden="true"></i>
                    ...
                    <li style="height: 50px">
                        <label>
                            <span class="custom-text fl-left">
                                <?php echo $lang['DONT_UPDATE_EXISTED_PRODUCTS_IMAGES'] ?>:
                                <span tooltip="<?php echo $lang['T_TIP_DONT_UPDATE_EXISTED_PRODUCTS_IMAGES'] ?>"
                                      class="mg-yml-tooltip"
                                      flow="right">
                                    <i class="fa fa-question-circle tip"
                                       aria-hidden="true"></i>
                    ...
                    <li>
                        <label>
                            <span class="custom-text fl-left">
                                ...
                                <span tooltip="<?php echo $lang['MULTIPLE_PRICE_INFO'] ?>"
                                      class="mg-yml-tooltip"
                                      flow="rightUp">
                                    <i class="fa fa-question-circle tip"
                                       aria-hidden="true"></i>
