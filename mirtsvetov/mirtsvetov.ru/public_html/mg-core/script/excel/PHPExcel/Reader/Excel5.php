	...
	private function _createFormulaFromTokens($tokens, $additionalData)
	{
		...
		foreach ($tokens as $token) {
			...
			case 'tSub': // subtraction
				...
				$spaceElement = $space0[$tokenData];
				$formulaStrings[] = "$op1$space1$spaceElement$op2";
				unset($space0, $space1);
				break;
			...
			case 'tUminus': // unary minus
				...
				$tokenData = $token['data'];
				$spaceElement = $space0[$tokenData];
				$formulaStrings[] = "$space1$spaceElement$op";
				unset($space0, $space1);
				break;
			case 'tPercent': // percent sign
				...
				$tokenData = $token['data'];
				$spaceElement = $space0[$tokenData];
				$formulaStrings[] = "$op$space1$spaceElement";
				unset($space0, $space1);
				break;
			...
			case 'tFuncV': // function with variable number of arguments
				if ($token['data']['function'] != '') {
					...
					$tokenDataFunction = $token['data']['function'];
					$spaceElement = $space0[$tokenDataFunction];
					$formulaStrings[] = "$space1$spaceElement(" . implode(',', $ops) . ")";
					unset($space0, $space1);
				} else {
					// add-in function
					$ops = array(); // array of operators
			...
			case 'tMemArea':
				...
				$tokenData = $token['data'];
				$spaceElement = $space0[$tokenData];
				$formulaStrings[] = "$space1$spaceElement";
				unset($space0, $space1);
				break;
