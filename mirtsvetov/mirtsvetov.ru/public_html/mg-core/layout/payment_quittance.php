...
?>
    <form action="<?php echo SITE?>/order" method="post">
      ...
      <input type="hidden" id="payer" name="payer" value="<?php echo $data['userInfo']->sname?> <?php echo $data['userInfo']->name?> <?php echo $data['userInfo']->pname?>">
  ...
  <?php } else { ?>
    <br>
    <?php echo lang('paymentRequisitesWait'); ?>
  <?php } ?>
<?php } else {
