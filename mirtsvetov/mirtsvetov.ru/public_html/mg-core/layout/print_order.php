...
<div class="form-wrapper">
  ...
  <?php echo $data['propertyOrder']['adress'] ?><br>
  <?php echo $data['propertyOrder']['email'] ?>
  <br/>
  <br/>
  ...
  <table class="who-pay">
    <tr>
      <td class="name" width="104">Плательщик:</td>
      <td width="760"><?php echo  str_replace('<br/>', '; ', htmlspecialchars_decode(trim(trim($data['customerInfo'],' '), ','))) ?></td>
    </tr>
  </table>
  <br />
  <br />
...
$imgSing = '';
$imgStamp = '';
if (!empty($data['propertyOrder']['usedsing']) && $data['propertyOrder']['usedsing'] == 'true') {
...
<table>
  <tr>
    <td width="240" style="vertical-align: bottom;" align="bottom">Генеральный директор</td>
    <td width="10"></td>
    <td width="140"><?php echo $imgSing ?></td>
    <td width="30"></td>
    <td width="240" style="vertical-align: bottom;" align="center">/<?php echo $data['propertyOrder']['general'] ?>/</td>
  </tr>
