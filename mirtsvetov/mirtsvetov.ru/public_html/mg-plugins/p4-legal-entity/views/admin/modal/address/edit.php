                        ...
                        <div class="p-modal__item">
                            ...
                            <div class="p-modal__content">
                                <div class="p-modal-form__field">
                                    ...
                                    <textarea class="p-modal-form__textarea" name="legal_address" autocomplete="off"><?php echo $address['address']; ?></textarea>
                                    <input type="hidden" name="legal_default" value="<?php echo $address['default']; ?>">
                                </div>
                            </div>
                        </div>
