...
<div class="cart_form nowrap js-amount-wrap amount_change flex" <?php if(!MG::enabledStorage()){echo abs($data['maxCount'])>0?'':'style="display:none"';} ?>>
    <button class="mines flex align-center center down js-amount-change-down js-cart-amount-change">-</button>
    ...
    <button class="plus flex align-center center up js-amount-change-up js-cart-amount-change js-onchange-price-recalc">+</button>
</div>