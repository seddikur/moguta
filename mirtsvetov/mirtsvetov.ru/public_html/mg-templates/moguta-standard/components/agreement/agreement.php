...
<section class="agreement">
    <label class="agreement__label">
        <input class="agreement__checkbox js-agreement-checkbox-<?php echo $data['button']; ?>" required
               type="checkbox">
        <span>
            <?php echo $data['text']; ?>
    ...
    <dialog class="agreement__modal js-agreement-modal">
        <?php if (!empty($data['layoutAgreementFromDB']) && $data['layoutAgreementFromDB'] === true) : ?>
            <div>
