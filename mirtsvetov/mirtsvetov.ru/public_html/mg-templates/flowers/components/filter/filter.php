...
<div class="mg-filter-head">
    ...
    <?php
    // Локали
    $data['property']['sorter']['option']['price_course|-1'] = 'убыванию цены';
    $data['property']['sorter']['option']['price_course|1'] = 'возрастанию цены';
    ...
    $data['property']['sorter']['option']['sort|-1'] = 'популярности';
                    ...
                    <div class="filter-select">
                        <div>
                            <label for="<?php echo $name ?>"
                                   class="label-field mg-filter-title">
                                <?php echo $prop['label']; ?>
                            </label>
                            <select id="<?php echo $name ?>"
                                ...
                                <?php foreach ($prop['option'] as $value => $text) {
                                    if(!in_array($value, array('price_course|-1', 'price_course|1', 'sort|-1'))) continue;
                ...
                if (isset($prop['special']) && $prop['special'] == 'date') { ?>
                    ...
                    <div class="wrapper-field">
                        <ul class="period-date">
                            <li>
                                <span class="label-field mg-filter-title">
                                    <?php echo $prop['label1'] ?>
                                </span>
                                <input class="from-<?php echo $prop['class'] ?>"
                                       type="text"
                                       name="<?php echo $name ?>[]"
                    ...
                    <div class="wrapper-field range-field">
                        <div class="price-slider-wrapper">
                            <ul class="price-slider-list flex nowrap">
                                <li>
                                    <label for="minCost" class="label-field from mg-filter-title">
                                        <?php echo $prop['label1'] ?>
                                    </label>
                                    <input type="text"
                                           id="minCost"
                                           ...
                                           name="<?php echo $name ?>[]"
                                           value="<?php echo $prop['min'] ?>"/>
                                </li>
                                <li>
                                    <label for="maxCost" class="label-field to mg-filter-title">
                                        <?php echo $prop['label2'] ?>
                                    </label>
                                    <input type="text"
                                           id="maxCost"
...
<?php if (MG::get('controller') == 'controllers_users' ||
    ...
    <div class="mg-filter-body"></div>

<?php } ?>


<div class="wrapper-field filter-buttons flex align-center">
...
<form name="filter" class="filter-form" action="<?php echo $arReuestUrl['path'] ?>" data-print-res="<?php echo MG::getSetting('printFilterResult') ?>">
