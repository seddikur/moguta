<div class="mg-filter flex align-center">
    <div class="show-filter mobile-hide"><svg><use xlink:href="<?php echo PATH_SITE_TEMPLATE; ?>/images/icons.svg#filter"></use></svg></div>
    ...
    if (!empty($data['props'])) {
      foreach ($data['props'] as $prop) {
        ...
        echo '<div class="mg-filter-item" id="id-'.$prop['idProp'].'" style="' . $prop['style'] . '">';
        ...
        echo '</span><span class="remove mobile-hide"></span>';
        echo '<ul class="mg-filter-list">';
        if (!empty($prop['data'])) {
          if ($prop['type'] == 'select') {
    ...
    ?>
    <div class="mobile-search"><input type="text" placeholder="Поиск.."><span class="clear flex align-center center"><svg><use xlink:href="<?php echo PATH_SITE_TEMPLATE; ?>/images/icons.svg#close"></use></svg></span></div>
</div>