            ...
            <div class="spoiler order-history" id="<?php echo $order['id'] ?>">
                ...
                <div class="spoiler-content content">
                    ...
                    <div class="line">
                        ...
                        <div class="price"><?php echo MG::numberFormat($perOrder['price']);?> руб./бак</div>
                        <div class="qty"><?php echo $perOrder['count'];?> бак × <?php $opFieldsM = new Models_OpFieldsProduct($perOrder['id']); echo $opFieldsM->get(21)['value'];?> шт.</div>
