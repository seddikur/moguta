    ...
    <div class="payment-option">
        <form class="js-orderForm" action="<?php echo SITE ?>/order?creation=1" method="post">
            <div class="step" style="display: none">
                ...
                <select name="customer" title="Плательщик" style="display: none;">
                    <option value="fiz">Физическое лицо</option>
                    <option value="yur" selected>Юридическое лицо</option>
                </select>
                    
            </div>
            
            <?php 
            // Вывод выбора юр лица и адреса доставки
            if (class_exists('LegalEntity')): ?>
                <div class="legal js-legal">
                    [p4-page-order]
                </div>
            <?php endif; ?>

            <textarea placeholder="Комментарий к заявке" title="Комментарий к заявке" name="info"></textarea>
            ...
            <div class="step">
                <div class="total-price-block total">
                    <div class="h3-like"><?php echo lang('orderPaymentTotal'); ?></div>
                    <div class="c-order__total">
                        ...
                        <form action="<?php echo SITE ?>/order" method="post" class="checkout-form">
                            <input type="submit" name="toOrder" class="checkout-btn button success" value="Оформить заявку" disabled>
                        </form>
                        <?php
