...
//if ($data['paramArray'][3]['value'] === 'true') {
	...
	foreach ($content as $item) {
		...
		$item = array(
			'Price'         => (float)round(round($item['price'], 2)*100),
			'Amount'        => (float)round(round($item['price'], 2)*100*$item['count']),
			'Quantity'      => $item['count'],
