...
<?php $array = array('1','2','5','6','7'); $rand = $array[array_rand($array)];?>
...
<div class="home-second">
	<div class="max">
		...
		<div class="chess flex align-center space-between">
			<img src="[webp url="<?php echo PATH_SITE_TEMPLATE;?>/images/home-nov-1.jpg"]" alt="">
		...
		<div class="chess flex align-center space-between">
			<img src="[webp url="<?php echo PATH_SITE_TEMPLATE;?>/images/home-nov-2.jpg"]" alt="">
			<div class="text content">
...
<div class="home-third">
	<img src="[webp url="<?php echo PATH_SITE_TEMPLATE;?>/images/home-nov-3.jpg"]" alt="">
</div>

<div class="home-last">
	<picture class="back">
		<source media="(min-width: 768px)" srcset="[webp url="<?php echo PATH_SITE_TEMPLATE;?>/images/desktop-nov-last.jpg"]">
		<img src="[webp url="<?php echo PATH_SITE_TEMPLATE;?>/images/desktop-nov-last.jpg"]">
	</picture>
	<div class="inner flex center column align-center">
