            ...
            <div class="max">
                <div class="contacts-block page flex column">
                    ...
                    <div class="item flex align-center nowrap">
                        ...
                        <a target="_blank" href="tel:+7 8342 23 33 23">+7 8342 23 33 23</a>
                    </div>
                    <div class="item flex align-center nowrap">
                        <span class="flex center align-center"><svg><use xlink:href="<?php echo PATH_SITE_TEMPLATE; ?>/images/icons.svg#email"></use></svg></span>
                        <a target="_blank" href="mailto:mail@mirtsvetov.ru">mail@mirtsvetov.ru</a>
                    </div>
                    <div class="item flex align-center nowrap">
        ...
        <?php elseif(URL::getClearUri()=='/content'): ?>
            <div class="max">
                <div class="gallery-list">
                    <a class="item" href="/content/07">
                        <img src="/uploads/gallery/7/1.webp" alt="">
                    ...
                    <a class="item" href="/content/03">
                        <img src="/uploads/gallery/3/03.jpg" alt="">
                        <div class="h2-like title">Spring / Summer 2025</div>
                    </a>
                    <a class="item" href="/content/04">
                        <img src="/uploads/gallery/4/04.jpg" alt="">
                        <div class="h2-like title">ORIGAMI</div>
                    </a>
                    <a class="item" href="/content/05">
                        <img src="/uploads/gallery/5/1.png" alt="">
                        <div class="h2-like title">Вдохновение в деталях</div>
                    </a>
                </div>
            </div>
        <?php endif;?>
