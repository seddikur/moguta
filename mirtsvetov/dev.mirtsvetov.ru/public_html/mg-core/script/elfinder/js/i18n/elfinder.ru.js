...
(function(root, factory) {
	...
	elFinder.prototype.i18.ru = {
		...
		messages   : {
			...
			'errArcMaxSize'        : 'Размер файлов в архиве превышает максимально разрешённый.',
			...
			'emptyFolderDrop' : 'Папка пуста\\A Перетащите файлы чтобы добавить', // from v2.1.6 added 30.12.2015
