...
class EventHook implements Hook {
  ...
  /**
   * Возвращает класс обрабатывающей функции.
   * @return string
   */
  public function getClass() {
    return !empty($this->_class)?$this->_class:'';
  }
  /**
   * Возвращает название обрабатывающей функции.
   * @return string
   */
  public function getFunctionName() {
    return !empty($this->_functionName)?$this->_functionName:'';
  }
}
