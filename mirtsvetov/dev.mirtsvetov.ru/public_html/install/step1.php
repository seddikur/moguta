...
<div class="install-body">
    ...
    <div class="center-wrapper step2">
        ...
        <?php if (empty($libError)):?>
            <div class="install-text">
                <form class="add-img-form" method="post" enctype="multipart/form-data" action=""
                      encoding="multipart/form-data" disable>
                    <div class="form-wrap"><div class="form-data"><h3 class="bd-title">Настройки подключения к базе данных</h3>
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="user" class="product-name-input" value="<?php if (!empty($user)) {echo $user;} ?>"
                                       placeholder="">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="nameDB" class="product-name-input"
                                       value="<?php if (!empty($nameDB)) {echo $nameDB;} ?>">
                            </td>
                        </tr>
                         <tr>
                            <td colspan="2" style="text-align: right;">
                                <span class="custom-text"><a role="button" href="javascript:void(0);" onclick="$('.display-none').show(); $(this).parents('tr').hide();"
                ...
                <div class="form-helper">
                    <h3 class="bd-title">Не знаете что делать?</h3>
                    <div class="help-text">
                        Ознакомьтесь с <a href="https://wiki.moguta.ru/ustanovka-sistemy" target="_blank">инструкцией по установке</a> или закажите <a href="https://moguta.ru/uslugi/usluga-po-ustanovke" target="_blank">услугу по установке</a>.
                    </div>
                </div>
                <div class="btn-wrap">
