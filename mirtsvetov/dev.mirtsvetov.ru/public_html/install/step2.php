        ...
        <?php if (empty($libError)):?>
            <div class="install-text">
                <form class="add-img-form" method="post" enctype="multipart/form-data" action=""
                        ...
                        <div class="radiobotton-text">
                            <label>
                                <input type="checkbox" name="engineType" value="test"
                                       class="checkit" <?php if (!empty($checkedTest)) {echo $checkedTest;} ?>>
                    ...
                    <input type="hidden" name="host" class="product-name-input" value="<?php if (!empty($host)) {echo $host; if (!empty($port)) {echo ":$port";} } ?>">
                    <input type="hidden" name="user" class="product-name-input" value="<?php if (!empty($user)) {echo $user;} ?>">
                    <input type="hidden" name="password" class="product-name-input" value="<?php if (!empty($password)) {echo $password;} ?>">
                    <input type="hidden" name="nameDB" class="product-name-input" value="<?php if (!empty($nameDB)) {echo $nameDB;} ?>">
                    <input type="hidden" name="prefix" class="product-name-input" value="<?php if (!empty($prefix)) {echo $prefix;} ?>">
                </form>
            </div>
        <?php endif ?>
    </div>
