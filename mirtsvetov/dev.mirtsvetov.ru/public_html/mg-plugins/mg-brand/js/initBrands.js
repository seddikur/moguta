...
var InitBrands = function() {
    ...
    let leftArrow = '<div class="brands__arrow brands__arrow-left" aria-label="' + lang.arrowLeft +'"><svg viewBox="0 0 512 512"><path d="M354.1 512l59.8-59.7L217.6 256 413.9 59.7 354.1 0l-256 256"></svg></div>';
    let rightArrow = '<div class="brands__arrow  brands__arrow-right" aria-label="' + lang.arrowRight + '"><svg viewBox="0 0 512 512"><path d="M157.9 0L98.1 59.7 294.4 256 98.1 452.3l59.8 59.7 256-256"></path></svg></div>';
