           ...
           <ul class="text-list">
            ...
            <div class="block-for-form" >
                <ul class="custom-form-wrapper type-img text-list">
                    <li><span style="width:80px;">src =</span> <input class="medium" type="text" name="src" value=""/> <a role="button" href="javascript:void(0);" class='browseImage link'>выбрать изображение</a> </li>
                    <li><span style="width:80px;">alt =</span> <input class="medium" type="text" name="alt" value=""/>
                        <a role="button" href="javascript:void(0);" class="desc-property fa fa-question-circle" title="Текст который будет выведен, если картинка не будет загружена"></a></li>
                    <li><span style="width:80px;">title =</span> <input class="medium" type="text" name="title" value=""/>
                        <a role="button" href="javascript:void(0);" class="desc-property fa fa-question-circle" title="Текст который будет выведен при наведении на картинку"></a></li>
                    <li><span style="width:80px;">href =</span> <input class="medium" type="text" name="href" value=""/>
                        <a role="button" href="javascript:void(0);" class="desc-property fa fa-question-circle" title="Ссылка, куда будет перенаправлен при нажатии на картинку. Если оставить поле пустным, перенаправлений не будет"></a></li>
                    <li><span style="width:80px;">высота =</span> <input class="medium" type="text" name="height" value=""/>
                        <a role="button" href="javascript:void(0);" class="desc-property fa fa-question-circle" title="Высота избражения, если оставить пустым, будем использована полная высота изображения"></a></li>
                    <li><span style="width:80px;">ширина =</span> <input class="medium" type="text" name="width" value=""/>
                        <a role="button" href="javascript:void(0);" class="desc-property fa fa-question-circle" title="Ширина избражения, если оставить пустым, будем использована полная ширина изображения"></a></li>
                    <li><span style="width:80px;">класс =</span> <input class="medium" type="text" name="class" value=""/>
                        <a role="button" href="javascript:void(0);" class="desc-property fa fa-question-circle" title="Класс, который будет применен к картинке, он позволит с помощью свойств css изменять параметры отображения блока"></a></li>
                </ul>
